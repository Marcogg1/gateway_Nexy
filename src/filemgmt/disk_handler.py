...
class DiskHandler:
    ...
    def get_disk_info(self, spec: str) -> int:
        """
    ...
    def get_sfs_config(self) -> dict:
        return self.sfs_config

    def get_upgrade_package_path(self) -> str:
    ...
    def __get_path_of_type(self, type_in: str) -> str:
        """
